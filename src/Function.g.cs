...
namespace DrawTests
{
    public class Function
    {
        ...
        private IModelStore<DrawTestsInputs> store;

        public async Task<DrawTestsOutputs> Handler(DrawTestsInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<DrawTestsInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<DrawTestsInputs,DrawTestsOutputs>(store, DrawTests.Execute);
